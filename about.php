               ...
               <div class="card">
                  <div class="card-body">
                     <div class="card-flex-column">
                        ...
                        <div class="about_us">
                           <h2>- Tentang Kami -</h2>
                           <p>Laundy Ku merupakan suatu pelayanan di bidang jasa yang menggunakan media online sebagai Platform untuk memudahkan pelanggan menemukan jasa laundry yang cepat dan mudah. Sebagaimana kita ketahui bahwasannya kemudahan mendapatkan berbagai macam jasa pada era sekarang sangatlah diperlukan, selain mudah dan cepat, kami menyediakan berbagai macam paket laundry yang sesuai dengan budget.</p>
                        </div>
                     </div>
                  </div>
               </div>
